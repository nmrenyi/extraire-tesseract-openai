#!/usr/bin/env python3
"""Upload a JSONL to Gemini Files API and launch a batch job.
...
Example:
  python batch-gemini/run_gemini_batch.py \
    --file batch-gemini/original-requests-gemini-3-flash-preview.jsonl \
    --model gemini-3-flash-preview \
    --display-name rosenwald-original-flash
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Upload JSONL and launch Gemini batch job")
