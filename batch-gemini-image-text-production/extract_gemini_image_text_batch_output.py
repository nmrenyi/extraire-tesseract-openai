#!/usr/bin/env python3
"""Extract TSV results from a Gemini multimodal batch output JSONL.
...
Example:
  python batch-gemini-image-text/extract_gemini_image_text_batch_output.py \
    --model gemini-3-flash-preview

Input default: batch-gemini-image-text/raw-batch-output/image-text-requests-<model>.output.jsonl
Output default: batch-gemini-image-text/raw-output-tsv/<model>/<key>.tsv
"""
...
def main() -> None:
    ...
    out_dir = args.out_dir or (
        ROOT / "batch-gemini-image-text" / "raw-output-tsv" / args.model
    )
